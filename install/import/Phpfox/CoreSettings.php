    ...
    foreach( $data as $value ) {
      ...
      switch( $value['var_name'] ) {
        ...
        case 'enable_facebook_connect' :
          ...
          break;
        case 'janrain_api_key' :
          $this->_setSetting('core.janrain.key', $value['value_actual'], '');
          break;
        case 'janrain_application_domain' :
          $this->_setSetting('core.janrain.domain', $value['value_actual'], '');
          break;
        case 'enable_janrain_login' :
          if( $value['value_actual'] ) {
            $this->_setSetting('core.janrain.enable', 'login', '');
          } else {
            $this->_setSetting('core.janrain.enable', 'none', '');
          }
          break;
        case 'ffmpeg_path' :
