...
<ul>
  ...
  <?php endif ?>
  <?php if( file_exists(APPLICATION_PATH . '/install/import/Phpfox') ): ?>
    <li>
      <a class="buttonlink import_ning" href="<?php echo $this->url(array('controller' => 'phpfoximport','action' => 'phpfox-instructions')) ?>">
        Phpfox Import
      </a>
      <p class="buttontext">
        Transfer your data from a Phpfox site to a new SocialEngine 4
        Installation
      </p>
      <br />
    </li>
